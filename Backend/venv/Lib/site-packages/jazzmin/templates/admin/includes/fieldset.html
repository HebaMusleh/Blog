...
<div class="form-group{% if line.fields|length == 1 and line.errors %} errors{% endif %}{% if not line.has_visible_field %} hidden{% endif %}">
    <div class="row">
        {% for field in line %}
            ...
            <div class="{% if line.fields|length != 1 %}col-auto fieldBox{% else %}col-sm-7{% endif %}
                         ...
                         {% if field.errors and not field.is_readonly %} errors{% endif %}
